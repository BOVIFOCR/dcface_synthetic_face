...
from util.util_ import read_obj, write_obj, write_obj2, viz_flow, estimate_normals, write_video, crop_mesh, \
...
class Reconstructor():
    def __init__(self, params):
        ...
        self.face_mark_model = LargeModelInfer("src/HRN/assets/pretrained_models/large_base_net.pth", device='cuda')
        ...
        with self.face_sess.as_default():
            with g1.as_default():
                with tf.gfile.FastGFile('src/HRN/assets/pretrained_models/segment_face.pb', 'rb') as f:
    ...
    # Bernardo
    def predict_base_only_bfm_coeffs(self, img, out_dir=None, save_name='', args=None):
