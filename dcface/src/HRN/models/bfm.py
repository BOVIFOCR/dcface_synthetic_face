...
class ParametricFaceModel:
    def __init__(self, 
        ...
        self.mean_tex_uv = np.load('src/HRN/assets/3dmm_assets/bfm_albedo_map_basis/bfm_tex_mean2.npy')
        self.mean_tex_uv = self.mean_tex_uv.reshape((1, -1))
        self.tex_base_uv = np.load('src/HRN/assets/3dmm_assets/bfm_albedo_map_basis/bfm_texmap_base2.npy')
