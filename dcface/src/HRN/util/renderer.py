...
class SRenderY(nn.Module):
    def __init__(self, image_size, obj_filename='src/HRN/assets/3dmm_assets/template_mesh/template_bfm.obj', uv_size=256, rasterizer_type='pytorch3d'):
        ...
        if rasterizer_type == 'pytorch3d':
            ...
            uvcoords = np.load('src/HRN/assets/3dmm_assets/template_mesh/bfm_uvs2.npy')[None, ...]
