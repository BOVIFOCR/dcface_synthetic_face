...
from src.recognition.reconstruction_helper import BFM_ReconstructionModel, make_3d_face_reconstruction_model
import torchmetrics
...
class TrainerWithBFMConsistencyConstraints(pl.LightningModule):
    """main class"""
    ...
    def __init__(self, datamodule=None, unet_config=None, optimizer=None, paths=None, sampler=None, ckpt_path=None, *args, **kwargs):
        ...
        super(TrainerWithBFMConsistencyConstraints, self).__init__()
        ...
        self.reconstruction_model: BFM_ReconstructionModel = make_3d_face_reconstruction_model(self.hparams.reconstruction)
    ...
    def load_state_dict(self, state_dict: 'OrderedDict[str, Tensor]', strict: bool = True):
        result = super(TrainerWithBFMConsistencyConstraints, self).load_state_dict(state_dict, strict=False)
    ...
    def shared_step(self, batch, batch_idx, stage='train', optimizer_idx=0, *args, **kwargs):
        ...
        if optimizer_idx == 0:
            ...
            if (self.hparams.losses.bfm_consistency_id_lambda + self.hparams.losses.bfm_consistency_exp_lambda + self.hparams.losses.bfm_consistency_pose_lambda) > 0:
