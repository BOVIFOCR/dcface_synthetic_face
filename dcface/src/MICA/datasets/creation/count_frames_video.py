...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        # path_video = '/datasets1/bjgbiesseck/FlorenceFace/Original/subject_01/Video/PTZ-Indoor.mjpeg'
        # path_video = '/datasets1/bjgbiesseck/FlorenceFace/Original/subject_01/Video/PTZ-Outdoor.mjpeg'
    else:
        path_video = sys.argv[1]
    
    if os.path.isfile(path_video):
        count = count_total_frames_manual(path_video)
        # count = count_total_frames_auto(path_video)
